            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  SkillCard(
                    title: 'All',
                    icon: Image.asset('assets/Matt_Right.png', width: 140, height: 140),
                    onTap: () => setState(() => selectedCategory = 'All'),
                  ),
                  SkillCard(
                    title: 'Cooking',
                    icon: Image.asset('assets/Matt_Cooking.png', width: 140, height: 140),
                    onTap: () => setState(() => selectedCategory = 'Cooking'),
                  ),
                  SkillCard(
                    title: 'Car Care',
                    icon: Image.asset('assets/Matt_CarMaintenance.png', width: 140, height: 140),
                    onTap: () => setState(() => selectedCategory = 'Car Care'),
                  ),
                  SkillCard(
                    title: 'Housekeeping',
                    icon: Image.asset('assets/Matt_HouseCleaning.png', width: 140, height: 140),
                    onTap: () => setState(() => selectedCategory = 'Housekeeping'),
                  ),
                  SkillCard(
                    title: 'Finances',
                    icon: Image.asset('assets/Matt_Finances.png', width: 140, height: 140),
                    onTap: () => setState(() => selectedCategory = 'Finances'),
                  ),
                  SkillCard(
                    title: 'Time Management',
                    icon: Image.asset('assets/Matt_TimeManagement.png', width: 140, height: 140),
